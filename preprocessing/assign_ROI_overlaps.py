...
ALL_ROIS = [
    'V1', 'V2', 'V3', 'hV4',                            # Benson
    'V3A', 'V3B',                                       # Benson
    'LO1', 'LO2', 'VO1', 'VO2',                         # Benson
    'IPS0', 'IPS1', 'IPS2', 'IPS3', 'IPS4', 'IPS5',     # Benson
...
home = str(Path.home())
surfer_dir = os.path.join (home, 'Documents/Magic_fMRI/DATA/MRI/derivatives/freesurfer/')    # the freesurfer directory
